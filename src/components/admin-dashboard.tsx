...
function createEmptyBank(): BankFormValues {
  return {
    ...
    name: "",
    slug: "",
    logoUrl: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80",
    description: "",
    featured: false,
  };
}
...
function createEmptyCard(bankId?: string): CardFormValues {
  return {
    ...
    description: "<p>Describe aquí la tarjeta con un tono claro y premium.</p>",
    benefits: [{ value: "" }],
    requirements: [{ value: "" }],
    annualFee: "",
    minIncome: "",
